...
Stigmata::Stigmata(Scene * scene, Vec2 position)
{
	cache = SpriteFrameCache::getInstance();

	itemSprite = Sprite::create("ITEMS/collectibles_138_stigmata.png");
...
void Stigmata::EraseItem()
{
	if (itemSprite->getTag() == ItemErase)
	{
		...
		Player->doGetItemAction(StigmataITEM);
	}
}
